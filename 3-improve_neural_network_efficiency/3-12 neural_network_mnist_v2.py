...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            print("Cost on training mnist_data: {}".format(cost))
            accuracy = self.accuracy(training_data, convert=True)
            print("Accuracy on training mnist_data: {} / {}".format(accuracy, n))

            if test_data:
                cost = self.total_cost(test_data, lmbda, convert=True)
                print("Cost on test mnist_data: {}".format(cost))
                accuracy = self.accuracy(test_data)
                print("Accuracy on test mnist_data: {} / {}".format(accuracy, len(test_data)))
