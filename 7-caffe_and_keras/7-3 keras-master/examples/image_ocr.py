...
which is both a generator class for test/train mnist_data and a Keras
...
# mnist_data. Image renderings are text are created on the fly
...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def get_batch(self, index, size, train):
        ...
        outputs = {'ctc': np.zeros([size])}  # dummy mnist_data for dummy loss function
