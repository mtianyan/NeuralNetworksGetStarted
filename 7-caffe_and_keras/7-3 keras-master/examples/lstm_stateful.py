...
of the mnist_data, with the window length = "lahead".
...
def gen_uniform_amp(amp=1, xn=10000):
    """Generates uniform random mnist_data between
    -amp and +amp
    and of length xn

    Arguments:
        amp: maximum/minimum range of uniform mnist_data
        xn: length of series
    """
...
# and will be dropped from the generated mnist_data
# before training the LSTM.
# Also, when lahead > 1,
# the preprocessing step later of "rolling window view"
# will also cause some points to be lost.
# For aesthetic reasons,
# in order to maintain generated mnist_data length = input_len after pre-processing,
