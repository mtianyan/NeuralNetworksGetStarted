...
latent_dim is unchanged, and the input mnist_data and model architecture are unchanged).
...
# Path to the mnist_data txt file on disk.
data_path = 'fra-eng/fra.txt'

# Vectorize the mnist_data.  We use the same approach as the training script.
# NOTE: the mnist_data must be identical, in order for the character -> integer
