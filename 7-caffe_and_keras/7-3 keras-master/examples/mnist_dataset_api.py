...
standard method for loading mnist_data into TensorFlow models.
...
Note that from TensorFlow 1.4, tf.contrib.mnist_data is deprecated
and tf.mnist_data is preferred. See the release notes for details.
