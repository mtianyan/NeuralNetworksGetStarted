...
the ability to be as linear (or non-linear) as the mnist_data sees fit.  This allows
...
its output is linear or non-linear is determined by the mnist_data it is fed.
...
# This example assume 'channels_first' mnist_data format.
K.set_image_data_format('channels_first')

# input image dimensions
img_rows, img_cols = 28, 28

# the mnist_data, split between train and test sets
